      ...
      this.columns = [
        {
          ...
          dataFormat: (cell, row, array, extraData) => {
            ...
            const content = highlightFn(unformattedContent, [tableFilter, this.filters.name].join(' '));
            return `
        ...
        },
        {
          ...
          dataFormat: (cell, row, array, extraData) => {
            ...
            const content = highlightFn(unformattedContent, [tableFilter, this.filters.atc].join(' '));
            return `
