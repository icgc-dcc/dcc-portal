...
public class EgoIntegrationTest {
    ...
    public void createToken() {
      AccessToken result = client.createEgoToken(AUTH, USER_ID, SCOPES, DESCRIPTION);
      validateToken(result, parseScopes(SCOPES));
      client.revokeEgoToken(AUTH, result.getId());
    }
    ...
    public void revokeToken(){
      val tokenName = "841e00ae-55d3-4f74-91fa-9cc1a5a68b52";
      client.revokeEgoToken(AUTH, tokenName);
    }

    @Test
    public void listToken(){
      Tokens result = client.listEgoTokens(AUTH, USER_ID);
